...
st.write("Your selected symptoms are as follow:")
st.write(symptoms)
...
if submit:
    ...
    st.subheader(f"You may have {prediction[0]}")
    st.write("NOTE:THIS IS SYSTEM GENERATED PREDICTION PLEASE CONSULT WITH YOUR DOCTOR BEFORE TAKING ANY ACTION BASED ON THIS PREDICTION")
